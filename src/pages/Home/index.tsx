...
export default function Home() {
  return (
    <main>
      ...
      <Section title="Nossos sabores" span="Novos e deliciosos!" paragraph="Sorvete bom é aquele feito com os melhores ingredientes! Aqui na gelateria todos os nossos produtos são naturais, à base de frutas e sem nenhum conservante! Também temos opções sem lactose e sem açúcar. Venha conhecer e perceber que tem como o sorvete ser delicioso e saudável ao mesmo tempo!" backgroundUrl={BannerSabores} isReverse={false} hasImage={true}/>

      <Section title="Nossos eventos" span="Delicias com sorvete!" paragraph="Mais do que uma sorveteria, uma extensão da sua casa! Estamos aqui prontinhos para te atender e oferecer os melhores eventos com os melhores sorvetes da sua vida! Venha nos conhecer e passar um tempo aqui com a gente." backgroundUrl={BannerEventos} isReverse={true} hasImage={true}/>

      <Section title="Sobre nós" span="Alegria em cada casquinha!" paragraph="Venha tomar o melhor sorvete da região aqui com a gente! Nós estamos há anos no mercado produzindo o que tem de melhor para o nosso cliente e você não pode ficar fora dessa. Venha nos fazer uma visita e aproveite o melhor atendimento e o melhor sorvete da cidade." backgroundUrl={BannerSobre} isReverse={false} hasImage={true}/>
